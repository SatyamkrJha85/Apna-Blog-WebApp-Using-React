package com.apnablog.blog.utils.factory;
...
public class BlogFactory {
    ...
    private static final int BLOG_USERS_MAX_SIZE = 6;
    private static final int BLOG_USERS_MIN_SIZE = 3;
    private static final int POSTS_MAX_SIZE = 10;
    private static final int POSTS_MIN_SIZE = 6;
    private static final int COMMENTS_MAX_SIZE = 4;
    private static final int COMMENTS_MIN_SIZE = 2;
